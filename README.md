...
3. Observe the newly opened file with HTML converted text (only in Windows). For Mac, the file is located in /HTMLConverter/MarkdownHTMLConverter/bin/Debug/netcoreapp3.1/convertedHTML.txt
